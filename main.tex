...
%\renewcommand{\cftfigureaftersnumb}{\hspace{1em}}
...
\addcontentsline{toc}{part}{Remerciements} \input{texte/remerciements}

\newpage
\addcontentsline{toc}{part}{Résumé} \input{texte/resume}
...
Enfin, le dernier chapitre récapitulera les choix méthodologiques que nous avons effectués pour répondre à la problématique.
	...
	\input{texte/eval-perf}
	\input{texte/transition}

\part{Construction d'une base d'images TEP simulées respirante}
	\input{texte/sim-simulation}
	\input{texte/sim-BD}
...
\part{Discussion et Conclusion}
	\input{texte/discussion}


\newpage
%\addcontentsline{toc}{part}{Conclusion}
%\input{texte/conclusion}

\addcontentsline{toc}{part}{Bibliographie}
\bibliographystyle{apalike}
\bibliography{bibliographieFinale}

\newpage

\addcontentsline{toc}{part}{Bibliographie personnelle}
\input{texte/biblioperso}
